...
from ..models.fable import fableHyperParams, apply_fable_to_model
from ..models.memit_ARE import MEMITAREHyperParams, apply_memit_ARE_to_model
...
ALG_DICT = {
    ...
    "MEMIT_ARE": apply_memit_ARE_to_model,
    "FABLE": apply_fable_to_model,
}
