...
def layer_stats(
    ...
    def get_ds():
        ...
        raw_ds = Dataset.from_file('/root/.cache/huggingface/datasets/wikipedia/20200501.en/1.0.0/009f923d9b6dd00c00c8cdc7f408f2b47f45dd4f5fb7982a21f9448f4afbe475/wikipedia-train.arrow')
        raw_ds = {'train': raw_ds}
        # raw_ds = load_dataset(
        #     ds_name,
